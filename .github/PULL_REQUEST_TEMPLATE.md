...
- [ ] To ensure the success of all pull request workflows, I execute `find . -type f -name '*.csproj' -execdir dotnet format {} \;` and `ng lint --fix` to automatically format the code.
