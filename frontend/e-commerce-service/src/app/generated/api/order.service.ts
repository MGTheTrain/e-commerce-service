...
export class OrderService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiV1OrdersOrderIdProductsProductIdItemGet(orderId: string, productId: string, observe?: 'body', reportProgress?: boolean): Observable<OrderItemResponseDTO>;
    public apiV1OrdersOrderIdProductsProductIdItemGet(orderId: string, productId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<OrderItemResponseDTO>>;
    public apiV1OrdersOrderIdProductsProductIdItemGet(orderId: string, productId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<OrderItemResponseDTO>>;
    public apiV1OrdersOrderIdProductsProductIdItemGet(orderId: string, productId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (orderId === null || orderId === undefined) {
            throw new Error('Required parameter orderId was null or undefined when calling apiV1OrdersOrderIdProductsProductIdItemGet.');
        }

        if (productId === null || productId === undefined) {
            throw new Error('Required parameter productId was null or undefined when calling apiV1OrdersOrderIdProductsProductIdItemGet.');
        }
        ...
        return this.httpClient.request<OrderItemResponseDTO>('get',`${this.basePath}/api/v1/orders/${encodeURIComponent(String(orderId))}/products/${encodeURIComponent(String(productId))}/item`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiV1OrdersUserGet(observe?: 'body', reportProgress?: boolean): Observable<Array<OrderResponseDTO>>;
    public apiV1OrdersUserGet(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<OrderResponseDTO>>>;
    public apiV1OrdersUserGet(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<OrderResponseDTO>>>;
    public apiV1OrdersUserGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<OrderResponseDTO>>('get',`${this.basePath}/api/v1/orders/user`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
