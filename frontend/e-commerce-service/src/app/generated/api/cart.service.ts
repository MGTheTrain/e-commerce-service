...
export class CartService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiV1CartsGet(observe?: 'body', reportProgress?: boolean): Observable<Array<CartResponseDTO>>;
    public apiV1CartsGet(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<CartResponseDTO>>>;
    public apiV1CartsGet(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<CartResponseDTO>>>;
    public apiV1CartsGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<CartResponseDTO>>('get',`${this.basePath}/api/v1/carts`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiV1CartsUserGet(observe?: 'body', reportProgress?: boolean): Observable<Array<CartResponseDTO>>;
    public apiV1CartsUserGet(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<CartResponseDTO>>>;
    public apiV1CartsUserGet(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<CartResponseDTO>>>;
    public apiV1CartsUserGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<CartResponseDTO>>('get',`${this.basePath}/api/v1/carts/user`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
