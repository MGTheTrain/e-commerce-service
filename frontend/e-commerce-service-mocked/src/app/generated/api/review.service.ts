...
export class ReviewService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiV1ReviewsUserUserIdGet(userId: string, observe?: 'body', reportProgress?: boolean): Observable<Array<ReviewResponseDTO>>;
    public apiV1ReviewsUserUserIdGet(userId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<ReviewResponseDTO>>>;
    public apiV1ReviewsUserUserIdGet(userId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<ReviewResponseDTO>>>;
    public apiV1ReviewsUserUserIdGet(userId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (userId === null || userId === undefined) {
            throw new Error('Required parameter userId was null or undefined when calling apiV1ReviewsUserUserIdGet.');
        }
        ...
        return this.httpClient.request<Array<ReviewResponseDTO>>('get',`${this.basePath}/api/v1/reviews/user/${encodeURIComponent(String(userId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
